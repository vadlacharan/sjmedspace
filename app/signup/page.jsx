    ...
    <div className="min-h-screen bg-gradient-to-b from-teal-100 to-teal-50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="space-y-1">
          <CardTitle className="text-3xl font-bold text-center text-teal-700">Sign up for MedSpace</CardTitle>
          <p className="text-center text-gray-600">Create your account to start learning</p>
        </CardHeader>
        <CardContent>
